...
// Responses API via response.completed (no [DONE]). See the stop_reason
// tables in the respective API docs.
...
func TestDialect_ChatTerminationEchoesEnvelope(t *testing.T) {
