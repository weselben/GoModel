...
func TestBuildDefaultConfig(t *testing.T) {
	...
	if got, want := cfg.Server.EnabledPassthroughProviders, []string{"openai", "anthropic", "openrouter", "zai", "vllm", "deepseek", "bailian", "kimi"}; !reflect.DeepEqual(got, want) {
...
func TestLoad_ConfigExample_UsesNestedModelCacheSettings(t *testing.T) {
	...
	withTempDir(t, func(dir string) {
		...
		wantProviders := []string{"openai", "anthropic", "openrouter", "zai", "vllm", "deepseek", "bailian", "kimi"}
